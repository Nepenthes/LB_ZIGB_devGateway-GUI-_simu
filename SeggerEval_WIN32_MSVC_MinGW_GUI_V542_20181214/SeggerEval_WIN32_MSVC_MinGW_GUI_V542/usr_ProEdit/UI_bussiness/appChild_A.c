...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
	{ FRAMEWIN_CreateIndirect, "About", ID_FRAMEWIN,   0, 480, 240, 320, 0 },
	{ BUTTON_CreateIndirect,   "OK",    GUI_ID_OK,   140, 140,  60,  20 },
};
...
static void _cbCallback(WM_MESSAGE * pMsg) {
	...
	case WM_PAINT:
		...
		GUI_DispStringInRect(&_aExText_A[0], &Rect, GUI_TA_LEFT);
		break;
